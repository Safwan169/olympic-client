...
import bgImage from "../../assets/career_banner.jpg"; // Update the path to your image
import INVITING from "../../assets/career/inviting.jpg";
import IGNITING from "../../assets/career/IGNITING.jpg";
import creating from "../../assets/career/CREATING.jpg";
import respecting from "../../assets/career/RESPECTING.jpg";
import philo1 from "../../assets/career/philo1.jpeg";
import philo2 from "../../assets/career/philo2.jpeg";
import philo3 from "../../assets/career/philo3.jpeg";
import olympian1 from "../../assets/career/olympians1.jpeg"
import olympian2 from "../../assets/career/olympians2.jpeg";
import olympian3 from "../../assets/career/olympians3.jpeg"
...
const Careers = () => {
  ...
  return (
    <div className="bg-black text-gray-200 min-h-screen">
      ...
      <div className="relative w-full h-[32rem] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/90 via-black/70 to-black/80 flex flex-col items-center justify-center px-4">
          ...
          <motion.div
            ...
            style={{
              background: `linear-gradient(to right, transparent, #E11D48, transparent)`, // brandRed color
            }}
          />
      ...
      <div className="bg-black text-gold-300 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-bold mb-6 text-gold-400">We make your test better</h1>
          <p className="text-lg max-w-3xl mx-auto text-gold-200">
            Life at Olympic is about chasing the TINGs. Our vision is to be a Responsible Total Foods Company,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 p-8 bg-gray-900 rounded-lg border border-gray-800">
            <h2 className="text-3xl font-bold mb-6 text-white text-center">
              {activeValueTab === "INVITING" && "COME HOME TO Olympic"}
            ...
            <p className="text-gray-300 text-center max-w-3xl mx-auto">
              {activeValueTab === "INVITING" && "A place that feels like home, Olympic exudes warm professionalism and is a workplace that is accepting of diverse ideas and thoughts while empowering employees as owners."}
              {activeValueTab === "IGNITING" && "We, at Olympic, provide an arena for our employees to experiment, learn on the job, even possibly fail and eventually create value beyond expectations."}
              {activeValueTab === "CREATING" && "At Olympic, we believe in creating value in everything we do. Our employees are empowered to innovate and contribute meaningfully to our success."}
            ...
            {activeValueTab === "INVITING" && (
              <div className="mt-10 text-center">
                <h3 className="text-xl font-bold mb-4 text-white">Olympic IS ALWAYS ABOUT Olympians</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                  <div className="relative h-48 rounded-lg overflow-hidden border border-gray-800 hover:border-red-600 transition-all duration-300">
                    <img src={olympian1} alt="Ownership and Accountability" className="w-full h-full object-cover" />
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-3">
                      <h4 className="text-white font-bold">OWNERSHIP AND ACCOUNTABILITY</h4>
                    </div>
                  </div>
                  <div className="relative h-48 rounded-lg overflow-hidden border border-gray-800 hover:border-red-600 transition-all duration-300">
                    <img src={olympian2} alt="Diversity & Inclusion" className="w-full h-full object-cover" />
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-3">
                      <h4 className="text-white font-bold">DIVERSITY & INCLUSION</h4>
                    </div>
                  </div>
                  <div className="relative h-48 rounded-lg overflow-hidden border border-gray-800 hover:border-red-600 transition-all duration-300">
                    <img src={olympian3} alt="Advocacy" className="w-full h-full object-cover" />
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-3">
