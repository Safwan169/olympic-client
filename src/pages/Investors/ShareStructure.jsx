...
const ShareStructure = () => {
  ...
  const data = [
    ...
    { name: "Foreign Investors", value: 34.3, color: goldAccent },
    ...
    <div className="bg-[#0a0a0a] text-white min-h-screen">
      ...
      <div className="relative w-full h-screen max-h-[32rem] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/90 via-black/70 to-black/80 flex flex-col items-center justify-center px-4">
          ...
          >
            Share <span style={{ color: goldAccent }}>Structure</span>
          </motion.h1>
          <motion.p
          ...
          >
            ...
            <span className="font-semibold" style={{ color: brandRed }}>
              DEC 31, 2024
            </span>
          </motion.p>
          <motion.div
      ...
      <div className="max-w-6xl mx-auto py-8 px-4">
          ...
          >
            <div className="bg-black/20 border border-gray-800 rounded-lg p-6 text-center max-w-3xl mx-auto">
              <h3 className="text-xl font-light mb-3">
                Share Structure <span className="font-medium">Overview</span>
              </h3>
              <div
              ...
              <p className="text-gray-300">
                Olympic Industries Limited has 199.93 million shares issued with
                a market capitalization of approximately ৳22.19 billion. Foreign
                investors hold the largest stake at 34.30%, followed by
                Directors and Sponsors at 32.38%.
              </p>
            </div>
          </motion.div>
        )}
            ...
            <div className="flex items-center justify-center min-h-screen">
              ...
              <div className="lg:col-span-2 bg-black/20 border border-gray-800 rounded-lg p-6">
                <h3 className="text-xl font-light mb-6">
                  Shareholding <span className="font-medium">Distribution</span>
                </h3>
        ...
        {(viewMode === "all" || viewMode === "table") && (
          ...
          >
            <h3 className="text-xl font-light mb-6">
              Detailed <span className="font-medium">Share Information</span>
            </h3>
        ...
        {viewMode === "historical" && (
          ...
          >
            <h3 className="text-xl font-light mb-6">
              Historical{" "}
              <span className="font-medium">Shareholding Patterns</span>
            </h3>
                ...
                <tbody>
                  {historicalData.map((year, index) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-4 text-right font-bold">
                        {year.directors.toFixed(2)}%
                      </td>
                      <td className="py-4 px-4 text-right font-bold">
                        {year.institutions.toFixed(2)}%
                      </td>
                      <td className="py-4 px-4 text-right font-bold">
                        {year.foreign.toFixed(2)}%
                      </td>
                      <td className="py-4 px-4 text-right font-bold">
                        {year.public.toFixed(2)}%
                      </td>
                    </tr>
                  ))}
                </tbody>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <ul className="text-sm text-gray-300 space-y-2">
                    <li>
                      • Foreign investor holdings decreased by 4.15% over the
                      three-year period
                    </li>
                    <li>
                      • Institutional investment increased steadily by
                      approximately 1.2% year-over-year
                    </li>
                    <li>
                      • Directors and Sponsors have gradually increased their
                      holdings by 1.18% since 2022
                    </li>
                    <li>
                      • General Public shareholding has remained relatively
                      stable around 10-11%
                    </li>
                  </ul>
                </div>
