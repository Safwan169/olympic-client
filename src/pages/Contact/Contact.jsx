...
//               boxShadow: `0 0 20px 2px hsla(${Math.random() * 60 + 240}, 100%, 70%, 0.8)`,
...
//               left: `${Math.random() * 100}%`,
//               top: `${Math.random() * 100}%`,
//               border: `4px solid hsla(${Math.random() * 60 + 240}, 100%, 70%, 0.3)`,
...
//         <div
//           className={`max-w-4xl mx-auto transition-all  duration-1000 transform ${animateIn ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}
//         >
...
//             <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-purple-600 rounded-full opacity-20 blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
...
//                 </div>
//                 <h2 className="text-3xl font-bold text-white mb-4 animate-pulse">Thank You!</h2>
//                 <p className="text-blue-300">Your message has been sent successfully. We'll get back to you soon.</p>
//               </div>
//             ) : (
...
//                 >
//                   <label htmlFor="department" className="block text-sm font-medium text-blue-400">
//                     Department
//                   </label>
//                   <select
//                     id="department"
...
//                 >
//                   <label className="block text-sm font-medium text-blue-400">Feedback Type</label>
...
//                           )}
//                         </div>
//                         <label htmlFor={option.id} className="ml-2 text-sm text-gray-300">
//                           {option.name}
//                         </label>
//                       </div>
//                     ))}
...
//                 >
//                   <label htmlFor="attachment" className="block text-sm font-medium text-blue-400">
...
//                         <svg className="w-10 h-10 mb-3 text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
//                   {files.length > 0 && (
//                     <div className="mt-2">
//                       <p className="text-sm text-blue-400">Files selected: {files.length}</p>
...
//                 },
//                 {
//                   icon: <svg className="h-6 w-6 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
//                     {cardProps.icon}
//                   </div>
//                   <h3 className="text-lg font-semibold text-white mb-2">{cardProps.title}</h3>
    ...
    <div className="min-h-screen flex flex-col bg-black text-white relative overflow-hidden">
        ...
        {[...Array(20)].map((_, i) => (
          <div
            ...
            style={{
              ...
              top: `${Math.random() * 100}%`,
              backgroundColor: `hsl(${
                Math.random() > 0.5 ? Math.random() * 40 + 0 : 45
              }, 90%, 60%)`,
              boxShadow: `0 0 10px hsla(${
                Math.random() > 0.5 ? Math.random() * 40 + 0 : 45
              }, 100%, 60%, 0.8)`,
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        >
          ...
          <div className="bg-gray-900 rounded-2xl shadow-2xl p-8 md:p-10 border border-red-800 hover:border-yellow-400 relative overflow-hidden transition-all duration-500">
            <div className="absolute -top-10 -right-10 w-40 h-40 bg-red-600 rounded-full opacity-20 blur-3xl animate-pulse"></div>
            <div
              className="absolute -bottom-10 -left-10 w-40 h-40 bg-yellow-500 rounded-full opacity-20 blur-3xl animate-pulse"
              ...
              <form onSubmit={handleSubmit} className="space-y-6 relative">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      value={name}
                      onChange={(e) => setName(e.target.value)}
                      className="w-full px-4 py-3 bg-gray-800 border border-gray-700 text-white rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-300 placeholder-gray-500"
                      placeholder="John Doe"
                    />
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    value={selectedDepartment}
                    onChange={(e) => setSelectedDepartment(e.target.value)}
                    className="w-full px-4 py-3 bg-gray-800 border border-gray-700 text-white rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-300"
                  >
                    <option value="">Select a Department</option>
                    {departments.map((dept) => (
                      <option key={dept.id} value={dept.id}>
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    {feedbackOptions.map((option) => (
                      <label
                        key={option.id}
                        className={`flex items-center p-3 rounded-lg bg-gray-800 border cursor-pointer 
                        ${
                          feedbackType === option.id
                            ? "border-red-500"
                            : "border-gray-700"
                ...
                <div className="flex justify-center pt-4">
                  <button
                    type="submit"
                    className="group relative inline-flex items-center px-8 py-4 rounded-full bg-gradient-to-r from-red-600 to-yellow-500 hover:from-red-500 hover:to-yellow-400 transition-transform transform hover:scale-105 shadow-lg text-white font-medium overflow-hidden"
                  >
                    <span className="absolute inset-0 bg-white/10 rounded-full scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left" />
                    <Send className="mr-2 h-5 w-5 z-10" />
