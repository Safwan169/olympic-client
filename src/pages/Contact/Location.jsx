                        ...
                        <div
                          ...
                          style={{
                            ...
                            border: `2px solid ${location.color}${
                              selectedLocation.id === location.id ? "" : "44"
                            }`,
                          }}
                        >
                    ...
                    {!isMapLoaded && (
                      <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-70 z-10">
                        <div className="w-16 h-16 relative">
                          ...
                          <div
                            className="w-12 h-12 rounded-full border-t-4 border-l-4 border-blue-500 animate-spin absolute inset-2"
                          ...
                          {[1, 2].map((img, index) => (
                            ...
                            >
                              <div
                                ...
                                style={{
                                  backgroundImage: `url('/api/placeholder/400/240')`,
                                }}
                              ></div>
                              <div
