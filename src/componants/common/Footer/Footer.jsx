...
const Footer = () => {
  ...
  const contactDetails = {
    address:
      "Amin Court, 6th Floor<br />62-63 Motijheel C/A<br />Dhaka-1000, Bangladesh",
      ...
      <div className="container mx-auto px-6  relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-[#1a1a1a] rounded-lg p-6 border border-red-800 shadow-lg">
              {" "}
              {/* Slightly darker bg */}
              ...
              <div className="flex justify-center mt-8">
                <Link
                  to={"/contact"}
                  className="bg-yellow-600 hover:bg-yellow-800 text-white  py-3 px-6 rounded-full transition duration-300"
                >
                  Contact Us
                </Link>
              </div>
        ...
        <div className="text-center py-4 text-sm flex flex-col md:flex-row justify-between items-center text-gray-500">
          <div>
            © {currentYear} <span className="text-red-500">Olympic BD</span>.
            All Rights Reserved. {/* Company name text red */}
          </div>
          <div className="mt-4 md:mt-0 flex flex-wrap justify-center md:justify-start">
            {" "}
