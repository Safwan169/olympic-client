...
const Navbar = () => {
  ...
  return (
    <div>
      {/* Desktop Navigation */}
      <nav
        className={`navbar text-white ${scrolled ? "navbar-solid bg-black" : "navbar-transparent"
          }`}
        ref={menuRef}
      >
        ...
        {/* Fixed Header on Scroll - Red Background as per SRS */}
        {scrolled && (
          <div className="fixed top-0 left-0 right-0 bg-red-700 z-50 hidden lg:block">
              ...
              <div className="flex items-center space-x-6">
                {allNavItems.map((item) => (
                  <div
                    ...
                    onMouseEnter={() =>
                      item.hasDropdown &&
                      handleDropdownHover(`scroll-${item.id}`)
                    }
                    onMouseLeave={() =>
                      item.hasDropdown &&
                      handleDropdownLeave(`scroll-${item.id}`)
                    }
                  >
                    {item.hasDropdown ? (
                      <>
                        <button
                          className={`flex items-center text-sm font-medium ${isParentActive(item.dropdownItems)
                              ? "text-yellow-300"
                              : "text-white hover:text-yellow-300"
                            }`}
                        >
                              ...
                              {item.dropdownItems.map((dropdownItem) => (
                                ...
                                >
                                  <NavLink
                                    to={dropdownItem.to}
                                    className={({ isActive }) =>
                                      `block px-4 py-2 text-sm hover:bg-gray-100 ${isActive
                                        ? "bg-gray-100 text-red-700 font-medium"
                                        : ""
                                      }`
                                    }
                      ...
                      <NavLink
                        to={item.to}
                        className={({ isActive }) =>
                          `text-sm hover:text-yellow-300 font-medium ${isActive ? "text-yellow-300" : "text-white"
                          }`
                        }
                      >
                        {item.label}
                ...
                {/* Search in Fixed Header */}
                <div className="search-container">
                  <input
                    type="text"
                    placeholder="Search..."
                    className={`search-input-small focus:outline-none ${searchActive ? "active" : ""
                      }`}
                  />
                  <button
                    onClick={toggleSearch}
...
//           <>
//             <button
//               className="flex justify-between items-center w-full font-medium text-white hover:text-yellow-300 px-4 transition-colors duration-300"
//               onClick={() => setIsOpen(!isOpen)}
//             >
//               {item.label}
//               <span
...
//       {/* Desktop Navigation */}
//       <nav
//         className={`navbar text-white transition-all duration-300 ease-in-out ${
//           scrolled ? "navbar-solid bg-black shadow-lg" : "navbar-transparent"
//         }`}
//         ref={menuRef}
//       >
//         <div className="container mx-auto hidden lg:flex items-center justify-between px-4 py-3">
...
//                                 to={dropdownItem.to}
//                                 className={({ isActive }) =>
//                                   `block px-4 py-3 text-sm transition-colors duration-300 hover:bg-gray-100 ${
//                                     isActive
//                                       ? "bg-gray-100 text-red-700 font-medium"
//                                       : ""
//                                   }`
...
//                     to={item.to}
//                     className={({ isActive }) =>
//                       `transition-colors duration-300 hover:text-yellow-300 font-semibold ${
...
//                 type="text"
//                 placeholder="Search..."
//                 className={`search-input focus:outline-none transition-all duration-300 ${
//                   searchActive ? "active" : ""
//                 }`}
//               />
//               <button
...
//               className="fixed top-0 left-0 right-0 bg-red-700 shadow-md z-50 hidden lg:block"
//             >
//               <div className="container mx-auto flex items-center justify-between px-4 py-3">
//                 {/* Logo stays on the left side here too */}
//                 <NavLink to="/" className="flex items-center">
//                   <img
//                     src="/olympic-logo.png"
//                     alt="Olympic Industries Logo"
...
//                                       to={dropdownItem.to}
//                                       className={({ isActive }) =>
//                                         `block px-4 py-2 text-sm hover:bg-gray-100 transition-colors duration-300 ${
//                                           isActive
//                                             ? "bg-gray-100 text-red-700 font-medium"
//                                             : ""
//                                         }`
...
//                           to={item.to}
//                           className={({ isActive }) =>
//                             `text-sm hover:text-yellow-300 font-medium transition-colors duration-300 ${
//                               isActive ? "text-yellow-300" : "text-white"
//                             }`
//                           }
//                         >
...
//                       type="text"
//                       placeholder="Search..."
//                       className={`search-input-small focus:outline-none transition-all duration-300 ${
//                         searchActive ? "active" : ""
//                       }`}
//                     />
//                     <button
//                       onClick={toggleSearch}
//                       className="text-white p-1 focus:outline-none transition-transform duration-300 hover:scale-110"
//                     >
//                       <FontAwesomeIcon icon={faSearch} size="sm" />
//                     </button>
//                   </div>
...
//           {/* Action Buttons for Mobile */}
//           <div className="flex items-center space-x-4">
//             <button className="text-white focus:outline-none transition-transform duration-300 hover:scale-110">
//               <FontAwesomeIcon icon={faSearch} />
//             </button>
//             <button className="text-white focus:outline-none transition-transform duration-300 hover:scale-110">
//               <FontAwesomeIcon icon={faShoppingBag} />
...
//               <NavLink
//                 to="/shop"
//                 className="flex items-center justify-center bg-red-700 text-white py-3 px-4 rounded font-medium transition-colors duration-300 hover:bg-red-800"
//                 onClick={() => setIsMobileMenuOpen(false)}
//               >
//                 <FontAwesomeIcon icon={faShoppingBag} className="mr-2" />
//                 SHOP NOW
...
//               <NavLink
//                 to="/recipes"
//                 className="flex items-center justify-center bg-yellow-600 text-white py-3 px-4 rounded font-medium transition-colors duration-300 hover:bg-yellow-700"
//                 onClick={() => setIsMobileMenuOpen(false)}
//               >
//                 <FontAwesomeIcon icon={faUtensils} className="mr-2" />
//                 RECIPE
...
//         <NavLink
//           to="/shop"
//           className="bg-red-700 text-white p-3 rounded-full shadow-lg hover:bg-red-800 transition-all duration-300 hover:scale-110"
//         >
//           <FontAwesomeIcon icon={faShoppingBag} size="lg" />
//         </NavLink>
//         <NavLink
